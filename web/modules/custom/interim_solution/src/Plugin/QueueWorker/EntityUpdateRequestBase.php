 ...
 */
abstract class EntityUpdateRequestBase extends QueueWorkerBase implements ContainerFactoryPluginInterface {
  ...
  public function processItem($data) {
    $this->queue_service->processItem($data, QueueService::UPDATE_QUEUE);
  }
